<div class="card text-center" style="width: 60%; margin: 0 auto;margin-top: 8%">
	...
	<div class="card-body" style="margin-left: 24%;width: 100%;">
		<form class="needs-validation" method="POST" action="<?php echo URL; ?>administration/Ajouter_reference">
			<table>
				<tr>
					<div class="form-group col-sm-6">
						<label>Nom de référence</label>
						<input type="text" name="nomReference" class="form-control text-center" required>
					</div>
				</tr>
				<tr>
					<div class="form-group col-sm-6">
						<label>Numéro de maquette</label>
						<input type="text" name="numMaquette" class="form-control text-center" required>
					</div>
				</tr>
				<tr>
					<div class="form-group col-sm-6">
					    <label for="">Désignation d'article</label>
					    <textarea class="form-control" id="" rows="2" name="designation" required></textarea>
					</div>
				</tr>
				<tr>
					<div class="form-group col-sm-6">
				...
				<tr>
					<div class="form-group col-sm-6">
						...
						<input type="number" name="nbrNC" class="form-control text-center" required>
					</div>
				</tr>
				<tr>
					<div class="form-group col-sm-6">
						...
						<select name="dureeDemarrage" class="form-control text-center" required>
							<option></option>
							<option value="fin">Fin de vie</option>
							<option value="serie">Série</option>
							<option value="projet">Projet(Phase E.I - DMS - Ramp UP)</option>
						</select>
					</div>
				</tr>
				<!-- <tr>
					...
					<div class="form-group col-sm-6">
						<input type="text" name="process" id="processus" class="form-control" disabled>	
						<input type="hidden" name="processuss" id="ref">
					</div>
				</tr> -->
				<tr>
					<div class="custom-control custom-checkbox" style="display: flex;margin-left: 10%;">
					  <input type="checkbox" class="custom-control-input" id="customCheck1" name="sr" value="3">
					  <label class="custom-control-label" for="customCheck1">Pièce Sécurité Réglementation</label>
					</div>
				</tr>
				<tr>
					<div class="custom-control custom-checkbox" style="display: flex;margin-left: 10%;">
					  <input type="checkbox" class="custom-control-input" id="customCheck2" name="top50" value="3">
					  <label class="custom-control-label" for="customCheck2">La référence est-il parmi les Top 50 ?</label>
					</div>
				</tr>
				<tr>
					<div class="custom-control custom-checkbox" style="display: flex;margin-left: 10%;">
					  <input type="checkbox" class="custom-control-input" id="customCheck3" name="modifProc" value="3">
					  <label class="custom-control-label" for="customCheck3">Le produit/processus est-il modifier ?</label>
					</div>
				</tr>
				<tr>
					<div class="custom-control custom-checkbox" style="display: flex;margin-left: 10%;">
					  <input type="checkbox" class="custom-control-input" id="customCheck4" name="ppm" value="3">
					  <label class="custom-control-label" for="customCheck4">Le PPM interne a-t-il dépassé l'objectif ?</label>
					</div>
				</tr>
				<tr>
					<div class="form-group" style="margin-top: 2%;">
						<button type="submit" style="margin-left: -50%;" class="btn btn-outline-primary col-sm-4">Ajouter la référence</button>
					</div>
				</tr>
			</table>
		</form>
