...
<div class="card text-center" style="margin-top: 8%;margin-left: 15%;width: 72%;">
	<div class="card-header <?php echo $success; ?>">
		Status des audits de poste
	</div>
	<div class="card-body" style="">
		<form action="<?php echo URL; ?>audit_de_poste/statistique" method="POST">
		...
		<div class="form-group col-sm-2">
			<label>Secteur</label>
			<select name="secteur1" class="form-control text-center col-sm-12" required>
				<option></option>
				<?php
		...
		<img src="<?php echo URL; ?>img/status_audit.png" >
	</div>
...
<div class="card text-center" style="margin-top: 4%;margin-left: 15%;width: 72%;">
	...
	<div class="card-body" style="">
		...
		<div class="form-group col-sm-2">
			<label>Secteur</label>
			<select name="secteur2" class="form-control text-center col-sm-12" required>
				<option></option>
				<?php
				foreach ($secteurs as $secteur) {
					if ($secteur->nom_secteur == $secteure) {
		...
		<img src="<?php echo URL; ?>img/audit_ecart.png" style="margin-top: 3.5%;">
	</div>
	<div class="card-footer <?php echo $success; ?>">
	</div>	
</div>
