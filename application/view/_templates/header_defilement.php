          ...
          if ($_SESSION["fonction"] == "responsable") { ?>
           <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="<?php echo URL; ?>administration/gestion_references/1">Gestion des comptes</a>
              </div>
           </li>
           <?php }else echo '<li></li>'; ?>
        </ul>
        ...
        <!-- /.dropdown -->
          <li class="dropdown" >
            ...
            <ul class="dropdown-menu dropdown-user" style="margin-left: -300%;">
                <li><a href="#"><i class="fa fa-user fa-fw"></i> Bonjour,<br><?php echo strtoupper($_SESSION["nom"])." ".$_SESSION["prenom"]; ?></a>
                </li>
