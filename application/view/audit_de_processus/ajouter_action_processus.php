<div class="card text-center" style="width: 60%; margin: 0 auto;margin-top: 8%">
	...
	<div class="card-body" style="margin-left: 24%;width: 100%;">
		<form class="needs-validation" method="POST" action="<?php echo URL; ?>audit_de_processus/ajouter_action_processus">
			<table>
				<tr>
				...
				<tr>
					<div style="display: -webkit-box;">
						<div class="form-group col-sm-4">
						    ...
						    <select id="audits" class="form-control text-center" required>
								<option></option>
								<?php
					...
					<div class="form-group col-sm-6">
						<input type="text" id="auditeurss" class="form-control" disabled value="" class="text-center">	
						<input type="hidden" name="auditeurs" value="" id="auditeurs">
					</div>
				</tr>
				<tr>
					<div class="form-group col-sm-6">
				...
				<tr>
					<div class="form-group col-sm-6">
					    ...
					    <textarea class="form-control" id="" rows="2" name="type6m"></textarea>
					</div>
				</tr>
				<tr>
					<div class="form-group col-sm-6">
				...
				<tr>
					<div class="form-group col-sm-6">
					    ...
					    <input type="text" name="critere" class="form-control">
					</div>
				</tr>
				<tr>
					<div class="form-group col-sm-6">
				...
				<tr>
					<div class="form-group col-sm-6">
					    ...
					    <textarea class="form-control" id="" rows="2" name="actionImmediate"></textarea>
					</div>
				</tr>
				<tr>
					<div class="form-group col-sm-6">
						<label>Délai</label>
						<input type="text" name="delai" class="form-control" required>
					</div>
				</tr>
				<tr>
					<div class="form-group col-sm-6">
				...
				<tr>
					<div class="form-group col-sm-6">
					    ...
					    <textarea class="form-control" id="" rows="2" name="actionCorrective"></textarea>
					</div>
				</tr>
				<tr>
					<div class="form-group col-sm-6">
						<label>Pilote</label>
						<input type="text" name="pilote" class="form-control" required>
					</div>
				</tr>
				<tr>
					<div class="form-group col-sm-6">
				...
				<tr>
					<div class="form-group col-sm-6">
						...
						<input type="week" name="delaiAction" class="form-control" required>
					</div>
				</tr>
				<tr>
					<div class="form-group col-sm-6">
						<label>Date de réalisation</label>
						<input type="Date" name="dateRealisation" class="form-control" style="text-align: center;">
					</div>
				</tr>
